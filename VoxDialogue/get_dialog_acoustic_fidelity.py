...
if __name__ == '__main__':
    ...
    dialog_json_dir = './Dialogue/scripts/daily_dialogue/acoustic_information/fidelity'
    dialog_dir = '/mnt/disk1/chengxize/data/VoxDialog/acoustic_information/fidelity'
