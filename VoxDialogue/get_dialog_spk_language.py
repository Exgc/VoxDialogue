...
def get_dialog_instruct(dialog_dir, json_dir, language='中文', rank=0, shard=10, generate=True, check=False,
                        cosyvoice_dir=None):
    assert cosyvoice_dir is not None, 'cosyvoice_dir is required'
    cosyvoice = CosyVoice(f'{cosyvoice_dir}/CosyVoice-300M-SFT')
...
if __name__ == '__main__':
    ...
    # 添加命令行参数
    parser.add_argument("--json_dir", type=str, default="examples/speaker_info/language",
                        help="Path to the input JSON directory.")
    parser.add_argument("--output_dir", type=str, default="path/to/output/language",
