...
def remove_punctuation(s):
    ...
    s_en = re.sub(r"[^a-zA-Z ]+", '', s.lower()).replace('i am', 'im').replace('theyre', 'they were')
    # print(s_en)
    return s_en
    # return cleaned  
...
model = (whisperx.load_model("large-v3", language='en', device=device, compute_type=compute_type))
